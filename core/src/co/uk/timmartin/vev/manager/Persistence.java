...
import static co.uk.timmartin.vev.enums.Particle.kBlank;
import static co.uk.timmartin.vev.enums.Particle.kE;
import static co.uk.timmartin.vev.enums.Particle.kH;
import static co.uk.timmartin.vev.enums.Particle.kM;
import static co.uk.timmartin.vev.enums.Particle.kQ;
import static co.uk.timmartin.vev.enums.Particle.kW;
import static co.uk.timmartin.vev.enums.Particle.kZ;
...
public class Persistence {
  ...
  public void tryLoadSetting() {
    ...
    if (settings.exists()) {
      try {
        ...
        autoSave = json.getInt("autoSave");
        longTap = (float) json.getDouble("longTap");
  ...
  public void trySaveSettings() {
    ...
    try {
      ...
      jsonSettings.put("autoSave", autoSave);
      jsonSettings.put("longTap", longTap);
